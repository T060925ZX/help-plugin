...
重置流程：
1. **自动备份**现有资源目录到 `resources/help-plugin-bak_时间戳/`
2. 删除当前的 `resources/help-plugin/` 目录
3. 根据网络环境选择最优源重新克隆仓库
   - 海外：GitHub
   - 国内：GitCode
4. 复制最新的 `Help_Lite.js` 到 `plugins/example/`
5. 提示重启 Bot 应用更改

> 💡 **提示**：重置后如需恢复自定义配置，可从备份目录手动还原
...
**A:** 
1. 找到备份目录：`resources/help-plugin-bak_时间戳/`
2. 手动复制备份的内容到 `resources/help-plugin/`
3. 重启 Bot
